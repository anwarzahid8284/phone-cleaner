...
public class BatteryFragment extends Fragment {
    TextView textViewPowerSource, textViewStatus,
            textViewLevel, textViewHealth, textViewVoltage, textViewCapacity, textViewTemperature, textViewTechnology, textViewPlugged, textViewSize;
    ...
    private void updateBatteryData(Intent intent) {
        ...
        if (present) {
            ...
            textViewStatus.setText("" + getString(pluggedLbl));
            ...
            textViewStatus.setText(statusLbl);
